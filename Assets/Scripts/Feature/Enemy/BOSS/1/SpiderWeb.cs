...
public class SpiderWeb : MonoBehaviour
{
    ...
    public void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            collision.gameObject.GetComponent<PlayerController>().Hurt(2, 0.8f);
            collision.gameObject.GetComponent<PlayerController>().Repel(transform.position, new Vector3(0, 0, 0));
